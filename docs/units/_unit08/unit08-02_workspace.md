...
{% include figure image_path="/assets/images/unit_images/u08/gui_rstudio_exp.png" caption="Work Environment in RStudio from Unit 1" %}
...
{% include figure image_path="/assets/images/unit_images/u08/structure.png" caption="Project directory structure" %}
