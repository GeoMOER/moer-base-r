...
{% include figure image_path="/assets/images/unit_images/u04/which-loop-to-choose.jpg" alt="Flow chart showing a decision tree which helps to choose the right loop." %}
